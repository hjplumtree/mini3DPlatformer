...
hero_w = 0.9; // hero width
hero_h = 0.9; // hero height
...
setInterval(() => {
  ...
  tile2 = getCubeValue(hero_x + hero_w - 0.1, hero_y, hero_z);
  tile3 = getCubeValue(hero_x, hero_y + hero_h - 0.1, hero_z);
  tile4 = getCubeValue(hero_x + hero_w - 0.1, hero_y + hero_h - 0.1, hero_z);
  ...
  if (l) {
    ...
    tile1 = getCubeValue(hero_x, hero_y, hero_z);
    tile2 = getCubeValue(hero_x, hero_y + hero_h - 0.1, hero_z);
    tile3 = getCubeValue(hero_x, hero_y, hero_z + hero_d);
    tile4 = getCubeValue(hero_x, hero_y + hero_h - 0.1, hero_z + hero_d);
  ...
  // If right key is pressed, go right
    ...
    tile1 = getCubeValue(hero_x + hero_w - 0.1, hero_y, hero_z);
    tile2 = getCubeValue(hero_x + hero_w - 0.1, hero_y + hero_h - 0.1, hero_z);
    tile3 = getCubeValue(hero_x + hero_w - 0.1, hero_y, hero_z + hero_d);
    tile4 = getCubeValue(
      hero_x + hero_w - 0.1,
      hero_y + hero_h - 0.1,
      hero_z + hero_d,
    ...
    if (tile1 == 1 || tile2 == 1 || tile3 == 1 || tile4 == 1) {
      ...
      hero_x = Math.floor(hero_x + hero_w - 0.1) - hero_w;
    }
    if (tile1 == 2 || tile2 == 2 || tile3 == 2 || tile4 == 2) {
      console.log("[COIN] collision right");
      // hero_x = Math.floor(hero_x + hero_w - 0.1) - hero_w;
    }
  }
  ...
  // If up key is pressed, go back
    ...
    tile2 = getCubeValue(hero_x + hero_w - 0.1, hero_y, hero_z);
    tile3 = getCubeValue(hero_x, hero_y, hero_z + hero_d);
    tile4 = getCubeValue(hero_x + hero_w - 0.1, hero_y, hero_z + hero_d);
  ...
  // If down key is pressed, go front
    ...
    tile1 = getCubeValue(hero_x, hero_y + hero_h - 0.1, hero_z);
    tile2 = getCubeValue(hero_x + hero_w - 0.1, hero_y + hero_h - 0.1, hero_z);
    tile3 = getCubeValue(hero_x, hero_y + hero_h - 0.1, hero_z + hero_d);
    tile4 = getCubeValue(
      hero_x + hero_w - 0.1,
      hero_y + hero_h - 0.1,
      hero_z + hero_d,
    ...
    if (tile1 == 1 || tile2 == 1 || tile3 == 1 || tile4 == 1) {
      ...
      hero_y = Math.floor(hero_y + hero_h - 0.1) - hero_h;
    }
  }
  ...
  if (hero_vz > 0) {
    ...
    tile2 = getCubeValue(hero_x + hero_w - 0.1, hero_y, hero_z + hero_d);
    tile3 = getCubeValue(hero_x, hero_y + hero_h - 0.1, hero_z + hero_d);
    tile4 = getCubeValue(
      hero_x + hero_w - 0.1,
      hero_y + hero_h - 0.1,
  ...
  // Move hero
  hero.style.transform = `translate3d(${hero_x * 200}px,${hero_y * 200}px,${
    hero_z * 200
  }px)`;
}, 16);
